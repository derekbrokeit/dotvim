...
" """""""""""""""""""""""""""
" " http://www.damtp.cam.ac.uk/user/rbw/vim-osx-cursor.html
...
"   set cursorline "cursorline required to continuously update cursor position
"   hi Cursor cterm=reverse ctermbg=black ctermfg=white "I like a reversed cursor, edit this to your liking
"   match Cursor /\%#/ "This line does all the work
" endfunction
...
"  if $TERM == "xterm-256color" || $ORIGTERM = "xterm-256color"
