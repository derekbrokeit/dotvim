...
nmap <silent> <Leader>fm :call FOLD_MARKER_CreateMarker()<CR>
vmap <silent> <Leader>fm :call FOLD_MARKER_CreateMarker()<CR>
nmap <silent> <Leader>fM :call FOLD_MARKER_CreateMarker('as_child')<CR>
vmap <silent> <Leader>fM :call FOLD_MARKER_CreateMarker('as_child')<CR>
nmap <silent> <Leader>em :call FOLD_MARKER_CreateMarker('as_comment')<CR>
vmap <silent> <Leader>em :call FOLD_MARKER_CreateMarker('as_comment')<CR>
nmap <silent> <Leader>eM :call FOLD_MARKER_CreateMarker('as_child', 'as_comment')<CR>
vmap <silent> <Leader>eM :call FOLD_MARKER_CreateMarker('as_child', 'as_comment')<CR>
